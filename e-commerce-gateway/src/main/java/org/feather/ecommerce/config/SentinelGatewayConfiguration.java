 ...
 * @package: org.feather.ecommerce.config
 * @className: SentinelGatewayConfigConfiguration
 * @author: feather
 * @description: Gateway 集成 Sentinel 实现限流
 * @since: 16-Oct-23 8:54 PM
 * @version: 1.0
 */
@Slf4j
@Configuration
    ...
    private void initCustomizedApis() {
        ...
        ApiDefinition api = new ApiDefinition("nacos-client-api")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    // 模糊匹配 /feather/ecommerce-nacos-client/ 及其子路径的所有请求
                    add(new ApiPathPredicateItem()
                            .setPattern("/feather/ecommerce-nacos-client/**")
                            // 根据前缀匹配
        ...
        ApiDefinition api1 = new ApiDefinition("nacos-client-api-1")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    add(new ApiPathPredicateItem()
                            // 精确匹配 /feather/ecommerce-nacos-client/nacos-client/service-instance
                            .setPattern("/feather/ecommerce-nacos-client" +
        ...
        ApiDefinition api2 = new ApiDefinition("nacos-client-api-2")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    add(new ApiPathPredicateItem()
                            // 精确匹配 /feather/ecommerce-nacos-client/nacos-client/project-config
                            .setPattern("/feather/ecommerce-nacos-client" +
