...
import org.feather.ecommerce.converter.BrandCategoryEnumConverter;
import org.feather.ecommerce.converter.GoodsCategoryEnumConverter;
import org.feather.ecommerce.converter.GoodsStatusEnumConverter;
...
public class EcommerceGoods {
    ...
    @Convert(converter = BrandCategoryEnumConverter.class)
    ...
    @Convert(converter = GoodsStatusEnumConverter.class)
    ...
    public static EcommerceGoods to(GoodsInfo goodsInfo) {
        ...
        ecommerceGoods.setGoodsStatus(GoodsStatusEnum.ONLINE);  // 可以增加一个审核的过程
